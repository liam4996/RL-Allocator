...
# Compatible eval_logger across lm-eval versions:
try:
    # many versions expose eval_logger via lm_eval.utils
    eval_logger = utils.eval_logger  # type: ignore[attr-defined]
except Exception:
    try:
        # some versions expose it via a dedicated logger module
        from lm_eval.logger import eval_logger  # type: ignore
    except Exception:
        # final fallback to a standard library logger
